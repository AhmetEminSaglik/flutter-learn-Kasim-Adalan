          ...
          child: Column(
            ...
            children: [
              SizedBox(
                  width: 400,
                  height: 250,
                  child: Image.network("https://picsum.photos/$width/$height")),
              Padding(
...
/*
class UpdateButtonWithGivenFuncAndProperty extends StatefulWidget {
  final int edge;
  ...
  UpdateButtonWithGivenFuncAndProperty(
      {required this.edge,
      required this.changeValueRange,
      required this.name,
      required this.function});

  @override
  State<UpdateButtonWithGivenFuncAndProperty> createState() =>
      _UpdateButtonWithGivenFuncAndPropertyState();
}

class _UpdateButtonWithGivenFuncAndPropertyState
    extends State<UpdateButtonWithGivenFuncAndProperty> {
  @override
  Widget build(BuildContext context) {
    return ElevatedButton(onPressed: widget.function, child: Text(widget.name));
  }
}
*/
